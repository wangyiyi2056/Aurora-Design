"""Prompt templates for RAG entity extraction and response generation.

Migrated from the LightRAG project (lightrag/prompt.py). Contains all prompt
templates used for entity/relationship extraction (text and JSON formats),
description summarization, keyword extraction, and RAG response generation.
"""
...
# ---------------------------------------------------------------------------
# Text-format entity extraction prompts
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Text-format entity extraction examples
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# JSON-format entity extraction prompts
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# JSON-format entity extraction examples
# ---------------------------------------------------------------------------
...
def get_prompt(key: str, **kwargs: Any) -> str:
    """Retrieve a prompt template and optionally format it with kwargs.

    Args:
        key: The prompt template key (e.g. ``"entity_extraction_system_prompt"``).
        **kwargs: Format string arguments to interpolate into the template.

    Returns:
        The formatted prompt string, or the raw template if no kwargs are
        provided or the template is not a string (e.g. a list of examples).
    """
