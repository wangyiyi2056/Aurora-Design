"""Subagent Manager for Aurora - manages subagent execution."""
...
from aurora_core.subagents.definition import SubagentDefinition
...
class SubagentManager:
    ...
    def __init__(
        ...
        self.agents_path = Path(agents_path or ".aurora/agents")
        self.global_agents_path = Path(
            global_agents_path or os.path.expanduser("~/.aurora/agents")
        )
