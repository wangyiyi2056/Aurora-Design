...
def get_intro_section() -> PromptSection:
    content = """You are Aurora, an intelligent data assistant. Use the instructions below and the tools available to you to assist the user.
...
def get_doing_tasks_section() -> PromptSection:
    ...
    items = [
        ...
        [
            "/help: Get help with using Aurora",
