"""Session Manager for Aurora - handles session persistence."""
...
class SessionManager:
    ...
    Sessions are stored as JSONL files under ~/.aurora/sessions/
    Each message, tool use, and result is written incrementally.
    """

    def __init__(self, base_path: Optional[str] = None):
        self.base_path = Path(base_path or os.path.expanduser("~/.aurora/sessions"))
