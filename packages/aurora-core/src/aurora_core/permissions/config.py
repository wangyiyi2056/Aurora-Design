"""Permission Configuration for Aurora."""
...
class PermissionConfig:
    ...
    - Project level (.aurora/settings.json)
    - User level (~/.aurora/settings.json)
    """
    ...
    def load(cls, path: Optional[str] = None) -> "PermissionConfig":
        ...
        settings_path = Path(path or os.path.expanduser("~/.aurora/settings.json"))
