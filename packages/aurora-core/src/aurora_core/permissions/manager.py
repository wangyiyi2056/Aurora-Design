"""Permission Manager for Aurora - manages permission checks."""
...
from aurora_core.permissions.mode import PermissionMode
from aurora_core.permissions.config import PermissionConfig
...
class PermissionManager:
    ...
    2. User-level settings (~/.aurora/settings.json)
    3. Project-level settings (.aurora/settings.json)
