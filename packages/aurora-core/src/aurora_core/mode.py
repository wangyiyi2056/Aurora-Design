"""Operational mode for Aurora — BI (web, read-only analysis) vs CODE (desktop, full tools).
...
from aurora_core.tool.base import Tool


class ChatMode(Enum):
    """Operational mode for the Aurora service.
