...
from chatbi_serve.evaluation.api import router as evaluation_router
from chatbi_serve.feedback.api import router as feedback_router
...
from chatbi_serve.prompt.api import router as prompt_router
from chatbi_serve.plugins.api import router as plugins_router
from chatbi_serve.skills.api import router as skills_router
from chatbi_serve.traces.api import router as traces_router
from chatbi_serve.users.api import router as users_router
