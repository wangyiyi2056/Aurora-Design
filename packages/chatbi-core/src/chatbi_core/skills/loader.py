"""Skills Loader for ChatBI - loads skills from Markdown files."""
...
from chatbi_core.skills.skill_file import SkillFile
...
class SkillsLoader:
    """Loads skills from .chatbi/skills/ directories.
    ...
    def __init__(
        ...
        self.project_skills_path = Path(
            project_skills_path or ".chatbi/skills"
        )
        self.global_skills_path = Path(
            global_skills_path or os.path.expanduser("~/.chatbi/skills")
        )
