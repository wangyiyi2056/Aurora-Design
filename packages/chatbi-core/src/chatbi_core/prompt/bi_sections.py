...
def get_bi_intro_section() -> PromptSection:
    content = """You are ChatBI, an intelligent data analysis assistant. You help users explore, analyze, and visualize data from uploaded files (CSV, Excel) and databases. Your primary capabilities:
