...
export const fr: Dict = {
  ...
  'settings.welcomeTitle': 'Configurer Aurora Design',
  ...
  'chat.tabChat': 'Chat',
  'chat.tabComments': 'Vue',
  'chat.commentsSoon': 'Vue — bientôt disponible',
  ...
  'tool.done': 'terminé',
  'tool.input': 'Entrée',
  'tool.titleRead': 'Lire fichier',
  'tool.titleList': 'Lister répertoire',
  'tool.titleGlob': 'Trouver fichiers',
  'tool.titleGrep': 'Rechercher contenu',
  'tool.titleBash': 'Exécuter commande',
  'tool.titleEdit': 'Modifier fichier',
  'tool.titleWrite': 'Écrire fichier',
  'tool.titleTask': 'Déléguer tâche',
  'tool.titleTodoWrite': 'Mettre à jour tâche',
  'tool.titleTodoRead': 'Lire tâche',
  'tool.titleFetch': 'Récupérer web',
  'tool.titleQuestion': 'Poser question',
  'tool.titleApplyPatch': 'Appliquer patch',
  'tool.titleSkill': 'Charger compétence',
  'tool.titleReasoning': 'Raisonnement',
  'tool.titlePython': 'Exécuter Python',
  'tool.titleDataProfile': 'Profil données',
  'tool.titleSql': 'Exécuter requête',
  'tool.titleDatasource': 'Datasource',
  'tool.statusDelegating': 'Délégation…',
  'tool.statusPlanning': 'Planification…',
  'tool.statusReadingPlan': 'Lecture plan…',
  'tool.statusReading': 'Lecture…',
  'tool.statusSearchingCode': 'Recherche codebase…',
  'tool.statusSearching': 'Recherche…',
  'tool.statusFindingFiles': 'Recherche fichiers…',
  'tool.statusFetching': 'Récupération…',
  'tool.statusEditing': 'Modification…',
  'tool.statusWriting': 'Écriture…',
  'tool.statusApplying': 'Application changements…',
  'tool.statusRunningCmd': 'Exécution commande…',
  'tool.statusThinking': 'Réflexion…',
  'tool.statusLoadingSkill': 'Chargement compétence…',
  'tool.statusWaitingInput': 'Attente entrée…',
  'tool.statusCompleted': 'Terminé',
  'tool.statusProcessing': 'Traitement…',
  ...
  'pet.tabBuiltInHint': 'Compagnons fournis avec Aurora Design — choisissez-en un et adoptez-le.',
  ...
  'pet.codexBundledTitle': 'Livré avec Aurora Design — aucun téléchargement nécessaire.',
