...
export const esES: Dict = {
  ...
  'settings.welcomeTitle': 'Configura Aurora Design',
  ...
  'chat.tabChat': 'Chat',
  'chat.tabComments': 'Vista',
  'chat.commentsSoon': 'Vista — próximamente',
  ...
  'tool.done': 'listo',
  'tool.input': 'Entrada',
  'tool.titleRead': 'Leer archivo',
  'tool.titleList': 'Listar directorio',
  'tool.titleGlob': 'Buscar archivos',
  'tool.titleGrep': 'Buscar contenido',
  'tool.titleBash': 'Ejecutar comando',
  'tool.titleEdit': 'Editar archivo',
  'tool.titleWrite': 'Escribir archivo',
  'tool.titleTask': 'Delegar tarea',
  'tool.titleTodoWrite': 'Actualizar tarea',
  'tool.titleTodoRead': 'Leer tarea',
  'tool.titleFetch': 'Obtener web',
  'tool.titleQuestion': 'Hacer pregunta',
  'tool.titleApplyPatch': 'Aplicar parche',
  'tool.titleSkill': 'Cargar habilidad',
  'tool.titleReasoning': 'Razonamiento',
  'tool.titlePython': 'Ejecutar Python',
  'tool.titleDataProfile': 'Perfil de datos',
  'tool.titleSql': 'Ejecutar consulta',
  'tool.titleDatasource': 'Datasource',
  'tool.statusDelegating': 'Delegando…',
  'tool.statusPlanning': 'Planificando…',
  'tool.statusReadingPlan': 'Leyendo plan…',
  'tool.statusReading': 'Leyendo…',
  'tool.statusSearchingCode': 'Buscando en codebase…',
  'tool.statusSearching': 'Buscando…',
  'tool.statusFindingFiles': 'Encontrando archivos…',
  'tool.statusFetching': 'Obteniendo…',
  'tool.statusEditing': 'Editando…',
  'tool.statusWriting': 'Escribiendo…',
  'tool.statusApplying': 'Aplicando cambios…',
  'tool.statusRunningCmd': 'Ejecutando comando…',
  'tool.statusThinking': 'Pensando…',
  'tool.statusLoadingSkill': 'Cargando habilidad…',
  'tool.statusWaitingInput': 'Esperando entrada…',
  'tool.statusCompleted': 'Completado',
  'tool.statusProcessing': 'Procesando…',
  ...
  'pet.tabBuiltInHint': 'Compañeros incluidos con Aurora Design — elige uno y adóptalo.',
  ...
  'pet.codexBundledTitle': 'Viene con Aurora Design — sin descarga.',
