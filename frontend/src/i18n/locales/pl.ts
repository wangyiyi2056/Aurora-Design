...
export const pl: Dict = {
  ...
  'settings.welcomeTitle': 'Skonfiguruj Aurora Design',
  ...
  'chat.tabChat': 'Czat',
  'chat.tabComments': 'Widok',
  'chat.commentsSoon': 'Widok — wkrótce',
  ...
  'tool.done': 'gotowe',
  'tool.input': 'Wejście',
  'tool.titleRead': 'Czytaj plik',
  'tool.titleList': 'Lista katalogu',
  'tool.titleGlob': 'Znajdź pliki',
  'tool.titleGrep': 'Szukaj w treści',
  'tool.titleBash': 'Uruchom polecenie',
  'tool.titleEdit': 'Edytuj plik',
  'tool.titleWrite': 'Zapisz plik',
  'tool.titleTask': 'Zleć zadanie',
  'tool.titleTodoWrite': 'Aktualizuj zadanie',
  'tool.titleTodoRead': 'Czytaj zadanie',
  'tool.titleFetch': 'Pobierz z sieci',
  'tool.titleQuestion': 'Zadaj pytanie',
  'tool.titleApplyPatch': 'Zastosuj łatkę',
  'tool.titleSkill': 'Załaduj umiejętność',
  'tool.titleReasoning': 'Wnioskowanie',
  'tool.titlePython': 'Uruchom Pythona',
  'tool.titleDataProfile': 'Profil danych',
  'tool.titleSql': 'Wykonaj zapytanie',
  'tool.titleDatasource': 'Datasource',
  'tool.statusDelegating': 'Zlecanie…',
  'tool.statusPlanning': 'Planowanie…',
  'tool.statusReadingPlan': 'Czytanie planu…',
  'tool.statusReading': 'Czytanie…',
  'tool.statusSearchingCode': 'Przeszukiwanie kodu…',
  'tool.statusSearching': 'Wyszukiwanie…',
  'tool.statusFindingFiles': 'Znajdowanie plików…',
  'tool.statusFetching': 'Pobieranie…',
  'tool.statusEditing': 'Edycja…',
  'tool.statusWriting': 'Zapisywanie…',
  'tool.statusApplying': 'Stosowanie zmian…',
  'tool.statusRunningCmd': 'Uruchamianie polecenia…',
  'tool.statusThinking': 'Myślenie…',
  'tool.statusLoadingSkill': 'Ładowanie umiejętności…',
  'tool.statusWaitingInput': 'Oczekiwanie na dane…',
  'tool.statusCompleted': 'Zakończono',
  'tool.statusProcessing': 'Przetwarzanie…',
  ...
  'pet.tabBuiltInHint': 'Towarzysze dołączeni do Aurora Design — wybierz jednego i adoptuj.',
  ...
  'pet.codexBundledTitle': 'Dostarczany z Aurora Design — bez pobierania.',
