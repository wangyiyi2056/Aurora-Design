...
export const ja: Dict = {
  ...
  'settings.welcomeTitle': 'Aurora Design を設定',
  ...
  'chat.tabChat': 'チャット',
  'chat.tabComments': 'ビュー',
  'chat.commentsSoon': 'ビュー — 近日公開',
  ...
  'tool.done': '完了',
  'tool.input': '入力',
  'tool.titleRead': 'ファイル読取',
  'tool.titleList': 'ディレクトリ一覧',
  'tool.titleGlob': 'ファイル検索',
  'tool.titleGrep': 'コンテンツ検索',
  'tool.titleBash': 'コマンド実行',
  'tool.titleEdit': 'ファイル編集',
  'tool.titleWrite': 'ファイル書込',
  'tool.titleTask': 'タスク委任',
  'tool.titleTodoWrite': 'Todo 更新',
  'tool.titleTodoRead': 'Todo 読取',
  'tool.titleFetch': 'Web 取得',
  'tool.titleQuestion': '質問',
  'tool.titleApplyPatch': 'パッチ適用',
  'tool.titleSkill': 'スキル読込',
  'tool.titleReasoning': '推論',
  'tool.titlePython': 'Python 実行',
  'tool.titleDataProfile': 'データ概要',
  'tool.titleSql': 'クエリ実行',
  'tool.titleDatasource': 'Datasource',
  'tool.statusDelegating': '委任中…',
  'tool.statusPlanning': '計画中…',
  'tool.statusReadingPlan': '計画読取中…',
  'tool.statusReading': '読取中…',
  'tool.statusSearchingCode': 'コード検索中…',
  'tool.statusSearching': '検索中…',
  'tool.statusFindingFiles': 'ファイル検索中…',
  'tool.statusFetching': '取得中…',
  'tool.statusEditing': '編集中…',
  'tool.statusWriting': '書込中…',
  'tool.statusApplying': '変更適用中…',
  'tool.statusRunningCmd': 'コマンド実行中…',
  'tool.statusThinking': '思考中…',
  'tool.statusLoadingSkill': 'スキル読込中…',
  'tool.statusWaitingInput': '入力待ち…',
  'tool.statusCompleted': '完了',
  'tool.statusProcessing': '処理中…',
  ...
  'pet.title': 'ペット',
  'pet.tabBuiltIn': '組み込み',
  'pet.tabBuiltInHint': 'Aurora Design に同梱された厳選コンパニオン — 選んで迎え入れよう。',
  ...
  'pet.codexBundled': '同梱',
  'pet.codexBundledTitle': 'Aurora Design に同梱 — ダウンロード不要。',
