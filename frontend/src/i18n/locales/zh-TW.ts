...
export const zhTW: Dict = {
  ...
  'settings.welcomeTitle': '初始化 Aurora Design',
  ...
  'chat.useDatabase': '使用資料庫',
  'chat.selectDatabase': '選擇資料庫',
  ...
  'tool.titleBash': '執行命令',
  'tool.titleEdit': '編輯檔案',
  'tool.titleWrite': '寫入檔案',
  'tool.titleTask': '委派任務',
  'tool.titleTodoWrite': '更新待辦',
  'tool.titleTodoRead': '讀取待辦',
  'tool.titleFetch': '擷取網頁',
  'tool.titleQuestion': '提問',
  'tool.titleApplyPatch': '套用修補',
  'tool.titleSkill': '載入技能',
  'tool.titleReasoning': '推理',
  'tool.titlePython': '執行 Python',
  'tool.titleDataProfile': '資料概覽',
  'tool.titleSql': '執行查詢',
  'tool.titleDatasource': '資料來源',
  'tool.statusDelegating': '委派中…',
  'tool.statusPlanning': '規劃中…',
  'tool.statusReadingPlan': '讀取計畫…',
  'tool.statusReading': '讀取中…',
  'tool.statusSearchingCode': '搜尋程式庫…',
  'tool.statusSearching': '搜尋中…',
  'tool.statusFindingFiles': '尋找檔案…',
  'tool.statusFetching': '擷取中…',
  'tool.statusEditing': '編輯中…',
  'tool.statusWriting': '寫入中…',
  'tool.statusApplying': '套用變更…',
  'tool.statusRunningCmd': '執行命令…',
  'tool.statusThinking': '思考中…',
  'tool.statusLoadingSkill': '載入技能…',
  'tool.statusWaitingInput': '等待輸入…',
  'tool.statusCompleted': '已完成',
  'tool.statusProcessing': '處理中…',
  ...
  'pet.title': '寵物',
  'pet.tabBuiltIn': '內建',
  'pet.tabBuiltInHint': 'Aurora Design 內建的精選寵物 — 一鍵領養。',
  ...
  'pet.codexBundled': '內建',
  'pet.codexBundledTitle': 'Aurora Design 內建寵物，無需下載。',
  ...
  'common.saving': '保存中…',
  'graphPanel.propertiesView.node.propertyNames.Neighbour': '鄰居',
  'graphPanel.propertiesView.node.propertyNames.description': '描述',
  'graphPanel.propertiesView.node.propertyNames.entity_id': '實體 ID',
  'graphPanel.propertiesView.node.propertyNames.entity_type': '實體類型',
  'graphPanel.propertiesView.node.propertyNames.keywords': '關鍵詞',
  'graphPanel.propertiesView.node.propertyNames.source_id': '源 ID',
  'knowledge.v2.doc.all': '全部',
  'knowledge.v2.doc.docDetails': '文件詳情',
  'knowledge.v2.doc.docDetailsDesc': '關於該文件及其處理狀態的詳細資訊。',
  'knowledge.v2.doc.dropFiles': '松開滑鼠以上傳檔案',
  'knowledge.v2.doc.errorStage': '錯誤發生階段：',
  'knowledge.v2.doc.insertText': '插入文字',
  'knowledge.v2.doc.insertTextDesc': '貼上或輸入文字內容以新增到目前知識庫。',
  'knowledge.v2.doc.insertTextPlaceholder': '請輸入文字內容…',
  'knowledge.v2.doc.insertTextTitle': '插入文字文件',
  'knowledge.v2.doc.noDocs': '暫無文件',
  'knowledge.v2.doc.noErrorMsg': '未記錄任何錯誤資訊。',
  'knowledge.v2.doc.page': '頁',
  'knowledge.v2.doc.perPage': '條/頁',
  'knowledge.v2.doc.processingError': '處理錯誤',
  'knowledge.v2.doc.reprocess': '重新處理',
  'knowledge.v2.doc.upload': '上傳檔案',
  'knowledge.v2.settings.cacheManagement': '快取管理',
  'knowledge.v2.settings.chunkSize': '分塊大小',
  'knowledge.v2.settings.chunks': '分塊數',
  'knowledge.v2.settings.clearLlmCache': '清除 LLM 快取',
  'knowledge.v2.settings.clearLlmCacheConfirm': '這將清除所有快取的 LLM 回應。未來的查詢將重新產生回應。此動作無法撤銷。',
  'knowledge.v2.settings.clearLlmCacheTitle': '清除 LLM 快取',
  'knowledge.v2.settings.collection': '集合名稱',
  'knowledge.v2.settings.deleteAll': '刪除全部文件',
  'knowledge.v2.settings.deleteAllDesc': '刪除目前知識庫中的所有文件。',
  'knowledge.v2.settings.deleteKbDesc': '永久刪除此知識庫及其所有資料。',
  'knowledge.v2.settings.documents': '文件數',
  'knowledge.v2.settings.kbInfo': '知識庫資訊',
  'knowledge.v2.settings.llmCache': 'LLM 回應快取',
  'knowledge.v2.settings.llmCacheDesc': '清除快取的 LLM 回應以強制重新產生。',
  'knowledge.v2.settings.name': '名稱',
  'knowledge.v2.settings.queryCache': '查詢快取',
  'knowledge.v2.settings.queryCacheDesc': '清除快取的查詢結果。',
  'knowledge.v2.settings.saveConfig': '儲存配置',
  'knowledge.v2.settings.strategy': '分塊策略',
  'knowledge.v2.doc.clickOrDragHint': '或點擊選擇檔案 · 支援多檔案 · 上傳即處理',
  'knowledge.v2.doc.continueAdd': '點擊或拖拽繼續新增檔案',
  'knowledge.v2.doc.dragFilesHere': '拖拽檔案至此處',
  'knowledge.v2.doc.releaseToUpload': '鬆開以上傳檔案',
  'knowledge.v2.doc.remove': '移除',
  'knowledge.v2.doc.retry': '重試',
  'knowledge.v2.doc.submittedProcessing': '已提交，後台處理中',
  'knowledge.v2.doc.uploadDesc': '拖拽檔案或點擊選擇，上傳後台自動處理，無需等待。',
  'knowledge.v2.doc.uploadFailedRetry': '個上傳失敗，請重試或移除後關閉。',
  'knowledge.v2.doc.uploadSuccessClose': '個檔案上傳完成，後台正在分析處理，視窗即將關閉…',
  'knowledge.v2.doc.uploadSuccessText': '個成功。',
  'graphPanel.sideBar.fullScreenControl.toggle': '切換全螢幕',
  'graphPanel.sideBar.layoutsControl.layouts.Circlepack': '圓包佈局',
  'graphPanel.sideBar.layoutsControl.layouts.Circular': '環形佈局',
  'graphPanel.sideBar.layoutsControl.layouts.Force Atlas': '力導向 Atlas 佈局',
  'graphPanel.sideBar.layoutsControl.layouts.Force Directed': '力導向佈局',
  'graphPanel.sideBar.layoutsControl.layouts.Noverlaps': '防重疊佈局',
  'graphPanel.sideBar.layoutsControl.layouts.Random': '隨機佈局',
  'graphPanel.sideBar.layoutsControl.select': '選擇佈局',
  'graphPanel.sideBar.layoutsControl.toggleAnimation': '運行佈局動畫',
  'graphPanel.sideBar.zoomControl.resetZoom': '重置檢視',
  'graphPanel.sideBar.zoomControl.rotateCcw': '逆時針旋轉',
  'graphPanel.sideBar.zoomControl.rotateCw': '顺时針旋轉',
  'graphPanel.sideBar.zoomControl.zoomIn': '放大',
  'graphPanel.sideBar.zoomControl.zoomOut': '縮小',
  'graphPanel.nodeTypes.chunk': '文字塊',
  'graphPanel.nodeTypes.concept': '概念',
  'graphPanel.nodeTypes.document': '文件',
  'graphPanel.nodeTypes.event': '事件',
  'graphPanel.nodeTypes.location': '地點',
  'graphPanel.nodeTypes.organization': '組織',
  'graphPanel.nodeTypes.person': '人物',
  'graphPanel.nodeTypes.unknown': '未知',
};
