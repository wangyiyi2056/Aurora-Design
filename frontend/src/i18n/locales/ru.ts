...
export const ru: Dict = {
  ...
  'settings.welcomeTitle': 'Настройте Aurora Design',
  ...
  'chat.tabChat': 'Чат',
  'chat.tabComments': 'Вид',
  'chat.commentsSoon': 'Вид — скоро',
  ...
  'tool.done': 'готово',
  'tool.input': 'Ввод',
  'tool.titleRead': 'Чтение файла',
  'tool.titleList': 'Список каталога',
  'tool.titleGlob': 'Поиск файлов',
  'tool.titleGrep': 'Поиск содержимого',
  'tool.titleBash': 'Выполнить команду',
  'tool.titleEdit': 'Редактировать файл',
  'tool.titleWrite': 'Записать файл',
  'tool.titleTask': 'Делегировать задачу',
  'tool.titleTodoWrite': 'Обновить задачу',
  'tool.titleTodoRead': 'Прочитать задачу',
  'tool.titleFetch': 'Загрузить веб',
  'tool.titleQuestion': 'Задать вопрос',
  'tool.titleApplyPatch': 'Применить патч',
  'tool.titleSkill': 'Загрузить навык',
  'tool.titleReasoning': 'Рассуждение',
  'tool.titlePython': 'Выполнить Python',
  'tool.titleDataProfile': 'Профиль данных',
  'tool.titleSql': 'Выполнить запрос',
  'tool.titleDatasource': 'Datasource',
  'tool.statusDelegating': 'Делегирование…',
  'tool.statusPlanning': 'Планирование…',
  'tool.statusReadingPlan': 'Чтение плана…',
  'tool.statusReading': 'Чтение…',
  'tool.statusSearchingCode': 'Поиск по коду…',
  'tool.statusSearching': 'Поиск…',
  'tool.statusFindingFiles': 'Поиск файлов…',
  'tool.statusFetching': 'Загрузка…',
  'tool.statusEditing': 'Редактирование…',
  'tool.statusWriting': 'Запись…',
  'tool.statusApplying': 'Применение изменений…',
  'tool.statusRunningCmd': 'Выполнение команды…',
  'tool.statusThinking': 'Размышление…',
  'tool.statusLoadingSkill': 'Загрузка навыка…',
  'tool.statusWaitingInput': 'Ожидание ввода…',
  'tool.statusCompleted': 'Завершено',
  'tool.statusProcessing': 'Обработка…',
  ...
  'pet.tabBuiltInHint': 'Подобранные питомцы в комплекте Aurora Design — выберите и забирайте.',
  ...
  'pet.codexBundledTitle': 'Поставляется с Aurora Design — загрузка не нужна.',
