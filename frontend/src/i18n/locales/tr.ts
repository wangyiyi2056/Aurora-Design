...
export const tr: Dict = {
  ...
  'settings.welcomeTitle': 'Aurora Design kurulumu',
  ...
  'chat.tabChat': 'Sohbet',
  'chat.tabComments': 'Görünüm',
  'chat.commentsSoon': 'Görünüm — yakında',
  ...
  'tool.done': 'bitti',
  'tool.input': 'Giriş',
  'tool.titleRead': 'Dosya Oku',
  'tool.titleList': 'Dizin Listele',
  'tool.titleGlob': 'Dosya Ara',
  'tool.titleGrep': 'İçerik Ara',
  'tool.titleBash': 'Komut Çalıştır',
  'tool.titleEdit': 'Dosya Düzenle',
  'tool.titleWrite': 'Dosya Yaz',
  'tool.titleTask': 'Görev Delege Et',
  'tool.titleTodoWrite': 'Görev Güncelle',
  'tool.titleTodoRead': 'Görev Oku',
  'tool.titleFetch': 'Web Getir',
  'tool.titleQuestion': 'Soru Sor',
  'tool.titleApplyPatch': 'Yama Uygula',
  'tool.titleSkill': 'Beceri Yükle',
  'tool.titleReasoning': 'Muhakeme',
  'tool.titlePython': 'Python Çalıştır',
  'tool.titleDataProfile': 'Veri Profili',
  'tool.titleSql': 'Sorgu Çalıştır',
  'tool.titleDatasource': 'Datasource',
  'tool.statusDelegating': 'Delege ediliyor…',
  'tool.statusPlanning': 'Planlanıyor…',
  'tool.statusReadingPlan': 'Plan okunuyor…',
  'tool.statusReading': 'Okunuyor…',
  'tool.statusSearchingCode': 'Kod tabanı aranıyor…',
  'tool.statusSearching': 'Aranıyor…',
  'tool.statusFindingFiles': 'Dosyalar bulunuyor…',
  'tool.statusFetching': 'Getiriliyor…',
  'tool.statusEditing': 'Düzenleniyor…',
  'tool.statusWriting': 'Yazılıyor…',
  'tool.statusApplying': 'Değişiklikler uygulanıyor…',
  'tool.statusRunningCmd': 'Komut çalıştırılıyor…',
  'tool.statusThinking': 'Düşünülüyor…',
  'tool.statusLoadingSkill': 'Beceri yükleniyor…',
  'tool.statusWaitingInput': 'Girdi bekleniyor…',
  'tool.statusCompleted': 'Tamamlandı',
  'tool.statusProcessing': 'İşleniyor…',
  ...
  'pet.tabBuiltInHint': 'Aurora Design ile gelen seçili dostlar — birini seç ve sahiplen.',
  ...
  'pet.codexBundledTitle': 'Aurora Design ile birlikte gelir — indirme gerekmez.',
