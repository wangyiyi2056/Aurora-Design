...
export const fa: Dict = {
  ...
  'settings.welcomeTitle': 'Aurora Design را راه‌اندازی کنید',
  ...
  'chat.tabChat': 'چت',
  'chat.tabComments': 'نما',
  'chat.commentsSoon': 'نما — به زودی',
  ...
  'tool.done': 'انجام شد',
  'tool.input': 'ورودی',
  'tool.titleRead': 'خواندن فایل',
  'tool.titleList': 'فهرست دایرکتوری',
  'tool.titleGlob': 'جستجوی فایل‌ها',
  'tool.titleGrep': 'جستجوی محتوا',
  'tool.titleBash': 'اجرای دستور',
  'tool.titleEdit': 'ویرایش فایل',
  'tool.titleWrite': 'نوشتن فایل',
  'tool.titleTask': 'تفویض وظیفه',
  'tool.titleTodoWrite': 'به‌روزرسانی وظیفه',
  'tool.titleTodoRead': 'خواندن وظیفه',
  'tool.titleFetch': 'دریافت وب',
  'tool.titleQuestion': 'پرسیدن سوال',
  'tool.titleApplyPatch': 'اعمال وصله',
  'tool.titleSkill': 'بارگذاری مهارت',
  'tool.titleReasoning': 'استدلال',
  'tool.titlePython': 'اجرای پایتون',
  'tool.titleDataProfile': 'پروفایل داده',
  'tool.titleSql': 'اجرای کوئری',
  'tool.titleDatasource': 'Datasource',
  'tool.statusDelegating': 'در حال تفویض…',
  'tool.statusPlanning': 'در حال برنامه‌ریزی…',
  'tool.statusReadingPlan': 'در حال خواندن برنامه…',
  'tool.statusReading': 'در حال خواندن…',
  'tool.statusSearchingCode': 'در حال جستجو در کد…',
  'tool.statusSearching': 'در حال جستجو…',
  'tool.statusFindingFiles': 'در حال یافتن فایل‌ها…',
  'tool.statusFetching': 'در حال دریافت…',
  'tool.statusEditing': 'در حال ویرایش…',
  'tool.statusWriting': 'در حال نوشتن…',
  'tool.statusApplying': 'در حال اعمال تغییرات…',
  'tool.statusRunningCmd': 'در حال اجرای دستور…',
  'tool.statusThinking': 'در حال فکر کردن…',
  'tool.statusLoadingSkill': 'در حال بارگذاری مهارت…',
  'tool.statusWaitingInput': 'در انتظار ورودی…',
  'tool.statusCompleted': 'انجام شد',
  'tool.statusProcessing': 'در حال پردازش…',
  ...
  'pet.tabBuiltInHint': 'همراهان منتخب همراه Aurora Design — یکی را انتخاب و فرزندخوانده کن.',
  ...
  'pet.codexBundledTitle': 'همراه Aurora Design ارائه می‌شود — نیازی به دانلود نیست.',
