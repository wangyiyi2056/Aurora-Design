...
export const en: Dict = {
  ...
  'settings.welcomeTitle': 'Set up Aurora Design',
  ...
  'chat.tabChat': 'Chat',
  'chat.tabComments': 'View',
  'chat.commentsSoon': 'View — coming soon',
  ...
  'tool.done': 'done',
  'tool.input': 'Input',
  'tool.titleRead': 'Read File',
  'tool.titleList': 'List Directory',
  'tool.titleGlob': 'Find Files',
  'tool.titleGrep': 'Search Content',
  'tool.titleBash': 'Run Command',
  'tool.titleEdit': 'Edit File',
  'tool.titleWrite': 'Write File',
  'tool.titleTask': 'Delegate Task',
  'tool.titleTodoWrite': 'Update Todo',
  'tool.titleTodoRead': 'Read Todo',
  'tool.titleFetch': 'Fetch Web',
  'tool.titleQuestion': 'Ask Question',
  'tool.titleApplyPatch': 'Apply Patch',
  'tool.titleSkill': 'Load Skill',
  'tool.titleReasoning': 'Reasoning',
  'tool.titlePython': 'Execute Python',
  'tool.titleDataProfile': 'Profile Data',
  'tool.titleSql': 'Execute Query',
  'tool.titleDatasource': 'Datasource',
  'tool.statusDelegating': 'Delegating…',
  'tool.statusPlanning': 'Planning…',
  'tool.statusReadingPlan': 'Reading plan…',
  'tool.statusReading': 'Reading…',
  'tool.statusSearchingCode': 'Searching codebase…',
  'tool.statusSearching': 'Searching…',
  'tool.statusFindingFiles': 'Finding files…',
  'tool.statusFetching': 'Fetching…',
  'tool.statusEditing': 'Editing…',
  'tool.statusWriting': 'Writing…',
  'tool.statusApplying': 'Applying changes…',
  'tool.statusRunningCmd': 'Running command…',
  'tool.statusThinking': 'Thinking…',
  'tool.statusLoadingSkill': 'Loading skill…',
  'tool.statusWaitingInput': 'Waiting for input…',
  'tool.statusCompleted': 'Completed',
  'tool.statusProcessing': 'Processing…',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with Aurora Design — pick one and adopt.',
  ...
  'pet.codexBundledTitle': 'Ships with Aurora Design — no download needed.',
  ...
  'graphPanel.graphLabels.deleteHistoryLabel': 'Remove {label} from search history',
  ...
  'graphPanel.nodeTypes.creature': 'Creature',

  'graphPanel.nodeTypes.method': 'Method',

  'graphPanel.nodeTypes.content': 'Content',

  'graphPanel.nodeTypes.data': 'Data',

  'graphPanel.nodeTypes.artifact': 'Artifact',

  'graphPanel.nodeTypes.naturalobject': 'Natural Object',
};
