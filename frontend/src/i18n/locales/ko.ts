...
export const ko: Dict = {
  ...
  'settings.welcomeTitle': 'Aurora Design 설정',
  ...
  'chat.tabChat': '채팅',
  'chat.tabComments': '보기',
  'chat.commentsSoon': '보기 — 곧 지원될 예정입니다.',
  ...
  'tool.done': '완료',
  'tool.input': '입력',
  'tool.titleRead': '파일 읽기',
  'tool.titleList': '디렉터리 목록',
  'tool.titleGlob': '파일 찾기',
  'tool.titleGrep': '내용 검색',
  'tool.titleBash': '명령 실행',
  'tool.titleEdit': '파일 편집',
  'tool.titleWrite': '파일 쓰기',
  'tool.titleTask': '작업 위임',
  'tool.titleTodoWrite': '할 일 업데이트',
  'tool.titleTodoRead': '할 일 읽기',
  'tool.titleFetch': '웹 가져오기',
  'tool.titleQuestion': '질문',
  'tool.titleApplyPatch': '패치 적용',
  'tool.titleSkill': '스킬 로드',
  'tool.titleReasoning': '추론',
  'tool.titlePython': 'Python 실행',
  'tool.titleDataProfile': '데이터 프로필',
  'tool.titleSql': '쿼리 실행',
  'tool.titleDatasource': 'Datasource',
  'tool.statusDelegating': '위임 중…',
  'tool.statusPlanning': '계획 중…',
  'tool.statusReadingPlan': '계획 읽는 중…',
  'tool.statusReading': '읽는 중…',
  'tool.statusSearchingCode': '코드베이스 검색 중…',
  'tool.statusSearching': '검색 중…',
  'tool.statusFindingFiles': '파일 찾는 중…',
  'tool.statusFetching': '가져오는 중…',
  'tool.statusEditing': '편집 중…',
  'tool.statusWriting': '쓰는 중…',
  'tool.statusApplying': '변경 적용 중…',
  'tool.statusRunningCmd': '명령 실행 중…',
  'tool.statusThinking': '생각 중…',
  'tool.statusLoadingSkill': '스킬 로드 중…',
  'tool.statusWaitingInput': '입력 대기 중…',
  'tool.statusCompleted': '완료',
  'tool.statusProcessing': '처리 중…',
  ...
  'pet.title': '펫',
  'pet.tabBuiltIn': '내장',
  'pet.tabBuiltInHint': 'Aurora Design에 기본 포함된 친구들 — 골라서 입양하세요.',
  ...
  'pet.codexBundled': '내장',
  'pet.codexBundledTitle': 'Aurora Design 에 내장 — 다운로드 불필요.',
