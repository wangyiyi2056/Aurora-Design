...
export const zhCN: Dict = {
  ...
  'tool.titleBash': '运行命令',
  'tool.titleEdit': '编辑文件',
  'tool.titleWrite': '写入文件',
  'tool.titleTask': '委派任务',
  'tool.titleTodoWrite': '更新待办',
  'tool.titleTodoRead': '读取待办',
  'tool.titleFetch': '抓取网页',
  'tool.titleQuestion': '提问',
  'tool.titleApplyPatch': '应用补丁',
  'tool.titleSkill': '加载技能',
  'tool.titleReasoning': '推理',
  'tool.titlePython': '执行 Python',
  'tool.titleDataProfile': '数据概览',
  'tool.titleSql': '执行查询',
  'tool.titleDatasource': '数据源',
  'tool.statusDelegating': '委派中…',
  'tool.statusPlanning': '规划中…',
  'tool.statusReadingPlan': '读取计划…',
  'tool.statusReading': '读取中…',
  'tool.statusSearchingCode': '搜索代码库…',
  'tool.statusSearching': '搜索中…',
  'tool.statusFindingFiles': '查找文件…',
  'tool.statusFetching': '抓取中…',
  'tool.statusEditing': '编辑中…',
  'tool.statusWriting': '写入中…',
  'tool.statusApplying': '应用变更…',
  'tool.statusRunningCmd': '运行命令…',
  'tool.statusThinking': '思考中…',
  'tool.statusLoadingSkill': '加载技能…',
  'tool.statusWaitingInput': '等待输入…',
  'tool.statusCompleted': '已完成',
  'tool.statusProcessing': '处理中…',
  ...
  'pet.title': '宠物',
  'pet.tabBuiltIn': '内置',
  'pet.tabBuiltInHint': 'Aurora Design 内置的精选宠物 — 一键领养。',
  ...
  'pet.codexBundled': '内置',
  'pet.codexBundledTitle': 'Aurora Design 内置宠物，无需下载。',
  ...
  'graphPanel.switchingTheme': '切换主题中...',
  'graphPanel.loadingGraphData': '加载图谱数据中...',
  'graphPanel.dataIsTruncated': '图谱数据已达到最大节点限制',
  'graphPanel.emptyGraph': '空图谱',

  'graphPanel.sideBar.settings.resetToDefault': '恢复默认',
  'graphPanel.sideBar.settings.settings': '设置',
  'graphPanel.sideBar.settings.healthCheck': '健康检查',
  'graphPanel.sideBar.settings.showPropertyPanel': '显示属性面板',
  'graphPanel.sideBar.settings.showSearchBar': '显示搜索栏',
  'graphPanel.sideBar.settings.showNodeLabel': '显示节点标签',
  'graphPanel.sideBar.settings.nodeDraggable': '节点可拖拽',
  'graphPanel.sideBar.settings.showEdgeLabel': '显示连线标签',
  'graphPanel.sideBar.settings.hideUnselectedEdges': '隐藏未选中的连线',
  'graphPanel.sideBar.settings.edgeEvents': '连线事件',
  'graphPanel.sideBar.settings.edgeSizeRange': '连线粗细范围',
  'graphPanel.sideBar.settings.maxQueryDepth': '最大查询深度',
  'graphPanel.sideBar.settings.maxNodes': '最大节点数',
  'graphPanel.sideBar.settings.maxLayoutIterations': '最大布局迭代次数',
  'graphPanel.sideBar.settings.save': '保存设置',
  'graphPanel.legend': '图例',
  'graphPanel.search.message': '搜索节点...',
  'graphPanel.search.placeholder': '搜索节点...',
  'graphPanel.propertiesView.errors.duplicateName': '名称重复',
  'graphPanel.propertiesView.success.entityMerged': '实体合并成功',
  'graphPanel.propertiesView.success.entityUpdated': '实体更新成功',
  'graphPanel.propertiesView.errors.updateFailed': '更新失败',
  'graphPanel.propertiesView.success.relationUpdated': '关系更新成功',
  'graphPanel.propertiesView.mergeDialog.refreshing': '刷新图谱数据中...',
  'graphPanel.propertiesView.mergeDialog.title': '合并节点',
  'graphPanel.propertiesView.mergeDialog.refreshHint': '请刷新图谱以查看更改。',
  'graphPanel.propertiesView.mergeDialog.keepCurrentStart': '保留当前',
  'graphPanel.propertiesView.mergeDialog.useMergedStart': '使用合并后的',
  'graphPanel.sideBar.settings.depth': '深度',
  'graphPanel.sideBar.settings.max': '最大节点数',
  'graphPanel.propertiesView.editPropertyDescription': '编辑属性详细信息',
  'graphPanel.propertiesView.mergeOptionLabel': '合并选项',
  'graphPanel.propertiesView.mergeOptionDescription': '选择合并方式',
  'graphPanel.graphLabels.refreshingTooltip': '刷新中...',
  'graphPanel.graphLabels.refreshGlobalTooltip': '刷新全景图谱',
  'graphPanel.graphLabels.refreshCurrentLabelTooltip': '刷新 {label}',
  'graphPanel.graphLabels.selectTooltip': '选择标签',
  'graphPanel.graphLabels.deleteHistoryLabel': '从搜索历史中删除 {label}',
  'graphPanel.graphLabels.noLabels': '未找到标签',
  'graphPanel.graphLabels.label': '标签',
  'graphPanel.graphLabels.placeholder': '搜索标签...',
  'graphPanel.propertiesView.node.title': '节点属性',
  'graphPanel.propertiesView.node.id': 'ID',
  'graphPanel.propertiesView.node.labels': '标签',
  'graphPanel.propertiesView.node.degree': '度',
  'graphPanel.propertiesView.node.properties': '属性',
  'graphPanel.propertiesView.node.relationships': '关系',
  'graphPanel.propertiesView.edge.title': '边属性',
  'graphPanel.propertiesView.edge.id': 'ID',
  'graphPanel.propertiesView.edge.type': '类型',
  'graphPanel.propertiesView.edge.source': '源节点',
  'graphPanel.propertiesView.edge.target': '目标节点',
  'graphPanel.propertiesView.edge.properties': '属性',
  'graphPanel.propertiesView.node.noNewNodes': '没有可添加的新节点',
  'graphPanel.propertiesView.node.deleteAllNodesError': '无法删除所有节点',
  'graphPanel.propertiesView.node.nodesRemoved': '节点已移除',
  'graphPanel.propertiesView.editProperty': '编辑属性',
  'graphPanel.refreshGraph': '刷新图谱数据',
  'graphPanel.propertiesView.mergeDialog.description': '合并描述',

  'knowledge.v2.list.chunks': '数据块',
  'knowledge.v2.list.strategy': '策略',
  'knowledge.v2.list.size': '大小',
  'knowledge.v2.list.overlap': '重叠',
  'knowledge.v2.list.deleteKb': '删除知识库',
  'knowledge.v2.list.deleteKbDesc': '确定要删除“{{name}}”吗？这将永久删除所有文档、块、实体和关系。此操作无法撤销。',
  'knowledge.v2.list.cancel': '取消',
  'knowledge.v2.list.delete': '删除',
  'knowledge.v2.list.createKb': '创建知识库',
  'knowledge.v2.list.noKbs': '暂无知识库',
  'knowledge.v2.list.noKbsDesc': '创建您的第一个知识库，开始导入文档并为 RAG 查询构建知识图谱。',
  'knowledge.v2.list.createKbDesc': '配置一个新的知识库，用于文档导入和 RAG 查询。',
  'knowledge.v2.list.name': '名称',
  'knowledge.v2.list.namePlaceholder': '我的知识库',
  'knowledge.v2.list.nameHint': '该知识库的唯一标识符',
  'knowledge.v2.list.chunkStrategy': '分块策略',
  'knowledge.v2.list.chunkSize': '分块大小',
  'knowledge.v2.list.chunkOverlap': '分块重叠',
  'knowledge.v2.list.createFailed': '创建知识库失败。它可能已存在。',
  'knowledge.v2.list.create': '创建',
  'knowledge.v2.detail.back': '返回',
  'knowledge.v2.detail.documents': '文档',
  'knowledge.v2.detail.graph': '图谱',
  'knowledge.v2.detail.settings': '设置',
  'knowledge.v2.doc.uploadDoc': '上传文档',
  'knowledge.v2.doc.uploading': '上传中...',
  'knowledge.v2.doc.empty': '暂无文档',
  'knowledge.v2.doc.emptyDesc': '上传 PDF、Word、TXT 或 Markdown 文档以构建您的知识图谱。',
  'knowledge.v2.doc.name': '文档名称',
  'knowledge.v2.doc.status': '状态',
  'knowledge.v2.doc.size': '大小',
  'knowledge.v2.doc.chunks': '数据块',
  'knowledge.v2.doc.time': '处理时间',
  'knowledge.v2.doc.actions': '操作',
  'knowledge.v2.doc.extracting': '实体抽取中',
  'knowledge.v2.doc.cancel': '取消',
  'knowledge.v2.doc.delete': '删除',
  'knowledge.v2.doc.deleteConfirm': '删除文档',
  'knowledge.v2.doc.deleteDesc': '确定要删除此文档吗？提取的图谱数据（除非被其他文档共享）将被移除。',
  'knowledge.v2.settings.chunkConfig': '分块配置',
  'knowledge.v2.settings.chunkConfigDesc': '修改未来文档的分块参数。',
  'knowledge.v2.settings.save': '保存更改',
  'knowledge.v2.settings.graphStatus': '图谱状态',
  'knowledge.v2.settings.entities': '实体数',
  'knowledge.v2.settings.relations': '关系数',
  'knowledge.v2.settings.storage': '存储引擎',
  'knowledge.v2.settings.dataOps': '数据操作',
  'knowledge.v2.settings.dataOpsDesc': '管理缓存和知识库的底层数据。',
  'knowledge.v2.settings.clearCache': '清除构建缓存',
  'knowledge.v2.settings.clearCacheDesc': '移除构建图谱过程中的临时解析缓存。释放存储空间，但重建时将重新开始。',
  'knowledge.v2.settings.clearQueryCache': '清除查询缓存',
  'knowledge.v2.settings.clearQueryCacheDesc': '移除 RAG 查询结果的缓存以获取最新的响应。',
  'knowledge.v2.settings.deleteAllDocs': '删除所有文档',
  'knowledge.v2.settings.deleteAllDocsDesc': '移除此知识库中的所有文档、实体和图谱数据。',
  'knowledge.v2.settings.dangerZone': '危险区域',
  'knowledge.v2.settings.deleteKb': '删除知识库',
  'knowledge.v2.settings.deleteKbHint': '永久删除此知识库及其所有数据。此操作无法撤销。',
  'knowledge.strategies.recursive': '递归分块',

  'knowledge.query.advancedSettings': '高级设置',
  'knowledge.query.getStructuredData': '获取结构化数据',
  'knowledge.query.rerank': '重排',
  'knowledge.query.references': '参考来源',
  'knowledge.doc.reprocess': '重新处理失败的文档',
  'knowledge.doc.clearLlmCache': '清除LLM缓存',
  'knowledge.doc.file': '文件',
  'knowledge.doc.id': 'ID',
  'knowledge.doc.trackId': '追踪ID',
  'knowledge.doc.contentLength': '内容长度',
  'knowledge.doc.summary': '摘要',
  'knowledge.doc.created': '创建时间',
  'knowledge.doc.updated': '更新时间',
  'knowledge.doc.duration': '耗时',
  'knowledge.settings.available': '可用',
  'knowledge.settings.strategy': '策略',
  'knowledge.settings.overlap': '重叠',
  'knowledge.settings.saved': '已保存',
  'knowledge.settings.clearCacheTitle': '清除缓存',
  'knowledge.settings.clearQueryCacheTitle': '清除查询缓存',
  'knowledge.settings.deleteAllDocsTitle': '删除所有文档',
  'knowledge.settings.deleteKbTitle': '删除知识库',
  'knowledge.settings.clear': '清除',
  'common.saving': '保存中…',
  'graphPanel.propertiesView.node.propertyNames.Neighbour': '邻居',
  'graphPanel.propertiesView.node.propertyNames.description': '描述',
  'graphPanel.propertiesView.node.propertyNames.entity_id': '实体 ID',
  'graphPanel.propertiesView.node.propertyNames.entity_type': '实体类型',
  'graphPanel.propertiesView.node.propertyNames.keywords': '关键词',
  'graphPanel.propertiesView.node.propertyNames.source_id': '源 ID',
  'knowledge.v2.doc.all': '全部',
  'knowledge.v2.doc.docDetails': '文档详情',
  'knowledge.v2.doc.docDetailsDesc': '关于该文档及其处理状态的详细信息。',
  'knowledge.v2.doc.dropFiles': '松开鼠标以上传文件',
  'knowledge.v2.doc.errorStage': '错误发生阶段：',
  'knowledge.v2.doc.insertText': '插入文本',
  'knowledge.v2.doc.insertTextDesc': '粘贴或输入文本内容以添加到当前知识库。',
  'knowledge.v2.doc.insertTextPlaceholder': '请输入文本内容…',
  'knowledge.v2.doc.insertTextTitle': '插入文本文件',
  'knowledge.v2.doc.noDocs': '暂无文档',
  'knowledge.v2.doc.noErrorMsg': '未记录任何错误信息。',
  'knowledge.v2.doc.page': '页',
  'knowledge.v2.doc.perPage': '条/页',
  'knowledge.v2.doc.processingError': '处理错误',
  'knowledge.v2.doc.reprocess': '重新处理',
  'knowledge.v2.doc.upload': '上传文件',
  'knowledge.v2.settings.cacheManagement': '缓存管理',
  'knowledge.v2.settings.chunkSize': '分块大小',
  'knowledge.v2.settings.chunks': '分块数',
  'knowledge.v2.settings.clearLlmCache': '清除 LLM 缓存',
  'knowledge.v2.settings.clearLlmCacheConfirm': '这将清除所有缓存的 LLM 响应。未来的查询将重新生成响应。此操作无法撤销。',
  'knowledge.v2.settings.clearLlmCacheTitle': '清除 LLM 缓存',
  'knowledge.v2.settings.collection': '集合名称',
  'knowledge.v2.settings.deleteAll': '删除全部文档',
  'knowledge.v2.settings.deleteAllDesc': '删除当前知识库中的所有文档。',
  'knowledge.v2.settings.deleteKbDesc': '永久删除此知识库及其所有数据。',
  'knowledge.v2.settings.documents': '文档数',
  'knowledge.v2.settings.kbInfo': '知识库信息',
  'knowledge.v2.settings.llmCache': 'LLM 响应缓存',
  'knowledge.v2.settings.llmCacheDesc': '清除缓存的 LLM 响应以强制重新生成。',
  'knowledge.v2.settings.name': '名称',
  'knowledge.v2.settings.queryCache': '查询缓存',
  'knowledge.v2.settings.queryCacheDesc': '清除缓存的查询结果。',
  'knowledge.v2.settings.saveConfig': '保存配置',
  'knowledge.v2.settings.strategy': '分块策略',
  'knowledge.v2.doc.clickOrDragHint': '或点击选择文件 · 支持多文件 · 上传即处理',
  'knowledge.v2.doc.continueAdd': '点击或拖拽继续添加文件',
  'knowledge.v2.doc.dragFilesHere': '拖拽文件到此处',
  'knowledge.v2.doc.releaseToUpload': '松开以上传文件',
  'knowledge.v2.doc.remove': '移除',
  'knowledge.v2.doc.retry': '重试',
  'knowledge.v2.doc.submittedProcessing': '已提交，后台处理中',
  'knowledge.v2.doc.uploadDesc': '拖拽文件或点击选择，上传后台自动处理，无需等待。',
  'knowledge.v2.doc.uploadFailedRetry': '个上传失败，请重试或移除后关闭。',
  'knowledge.v2.doc.uploadSuccessClose': '个文件上传完成，后台正在分析处理，窗口即将关闭…',
  'knowledge.v2.doc.uploadSuccessText': '个成功。',
  'graphPanel.sideBar.fullScreenControl.toggle': '切换全屏',
  'graphPanel.sideBar.layoutsControl.layouts.Circlepack': '圆包布局',
  'graphPanel.sideBar.layoutsControl.layouts.Circular': '环形布局',
  'graphPanel.sideBar.layoutsControl.layouts.Force Atlas': '力导向 Atlas 布局',
  'graphPanel.sideBar.layoutsControl.layouts.Force Directed': '力导向布局',
  'graphPanel.sideBar.layoutsControl.layouts.Noverlaps': '防重叠布局',
  'graphPanel.sideBar.layoutsControl.layouts.Random': '随机布局',
  'graphPanel.sideBar.layoutsControl.select': '选择布局',
  'graphPanel.sideBar.layoutsControl.toggleAnimation': '运行布局动画',
  'graphPanel.sideBar.zoomControl.resetZoom': '重置视图',
  'graphPanel.sideBar.zoomControl.rotateCcw': '逆时针旋转',
  'graphPanel.sideBar.zoomControl.rotateCw': '顺时针旋转',
  'graphPanel.sideBar.zoomControl.zoomIn': '放大',
  'graphPanel.sideBar.zoomControl.zoomOut': '缩小',
  'graphPanel.nodeTypes.chunk': '文本块',
  'graphPanel.nodeTypes.concept': '概念',
  'graphPanel.nodeTypes.document': '文档',
  'graphPanel.nodeTypes.event': '事件',
  'graphPanel.nodeTypes.location': '地点',
  'graphPanel.nodeTypes.organization': '组织',
  'graphPanel.nodeTypes.person': '人物',
  'graphPanel.nodeTypes.unknown': '未知',

  'graphPanel.nodeTypes.creature': '生物',

  'graphPanel.nodeTypes.method': '方法',

  'graphPanel.nodeTypes.content': '内容',

  'graphPanel.nodeTypes.data': '数据',

  'graphPanel.nodeTypes.artifact': '人造物',

  'graphPanel.nodeTypes.naturalobject': '自然物',
