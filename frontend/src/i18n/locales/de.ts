...
export const de: Dict = {
  ...
  'settings.welcomeTitle': 'Aurora Design einrichten',
  ...
  'chat.tabChat': 'Chat',
  'chat.tabComments': 'Ansicht',
  'chat.commentsSoon': 'Ansicht — demnächst',
  ...
  'tool.done': 'fertig',
  'tool.input': 'Eingabe',
  'tool.titleRead': 'Datei lesen',
  'tool.titleList': 'Verzeichnis auflisten',
  'tool.titleGlob': 'Dateien finden',
  'tool.titleGrep': 'Inhalt suchen',
  'tool.titleBash': 'Befehl ausführen',
  'tool.titleEdit': 'Datei bearbeiten',
  'tool.titleWrite': 'Datei schreiben',
  'tool.titleTask': 'Aufgabe delegieren',
  'tool.titleTodoWrite': 'Todo aktualisieren',
  'tool.titleTodoRead': 'Todo lesen',
  'tool.titleFetch': 'Web abrufen',
  'tool.titleQuestion': 'Frage stellen',
  'tool.titleApplyPatch': 'Patch anwenden',
  'tool.titleSkill': 'Skill laden',
  'tool.titleReasoning': 'Schlussfolgerung',
  'tool.titlePython': 'Python ausführen',
  'tool.titleDataProfile': 'Datenprofil',
  'tool.titleSql': 'Abfrage ausführen',
  'tool.titleDatasource': 'Datasource',
  'tool.statusDelegating': 'Delegieren…',
  'tool.statusPlanning': 'Planung…',
  'tool.statusReadingPlan': 'Plan lesen…',
  'tool.statusReading': 'Lesen…',
  'tool.statusSearchingCode': 'Codebase durchsuchen…',
  'tool.statusSearching': 'Suchen…',
  'tool.statusFindingFiles': 'Dateien finden…',
  'tool.statusFetching': 'Abrufen…',
  'tool.statusEditing': 'Bearbeiten…',
  'tool.statusWriting': 'Schreiben…',
  'tool.statusApplying': 'Änderungen anwenden…',
  'tool.statusRunningCmd': 'Befehl ausführen…',
  'tool.statusThinking': 'Denken…',
  'tool.statusLoadingSkill': 'Skill laden…',
  'tool.statusWaitingInput': 'Warte auf Eingabe…',
  'tool.statusCompleted': 'Abgeschlossen',
  'tool.statusProcessing': 'Verarbeitung…',
  ...
  'pet.tabBuiltInHint': 'Mit Aurora Design gebündelte Begleiter — auswählen und adoptieren.',
  ...
  'pet.codexBundledTitle': 'Wird mit Aurora Design ausgeliefert — kein Download nötig.',
