...
export const ptBR: Dict = {
  ...
  'settings.welcomeTitle': 'Configure o Aurora Design',
  ...
  'chat.tabChat': 'Chat',
  'chat.tabComments': 'Visualização',
  'chat.commentsSoon': 'Visualização — em breve',
  ...
  'tool.done': 'concluído',
  'tool.input': 'Entrada',
  'tool.titleRead': 'Ler arquivo',
  'tool.titleList': 'Listar diretório',
  'tool.titleGlob': 'Procurar arquivos',
  'tool.titleGrep': 'Pesquisar conteúdo',
  'tool.titleBash': 'Executar comando',
  'tool.titleEdit': 'Editar arquivo',
  'tool.titleWrite': 'Escrever arquivo',
  'tool.titleTask': 'Delegar tarefa',
  'tool.titleTodoWrite': 'Atualizar tarefa',
  'tool.titleTodoRead': 'Ler tarefa',
  'tool.titleFetch': 'Buscar na web',
  'tool.titleQuestion': 'Fazer pergunta',
  'tool.titleApplyPatch': 'Aplicar patch',
  'tool.titleSkill': 'Carregar habilidade',
  'tool.titleReasoning': 'Raciocínio',
  'tool.titlePython': 'Executar Python',
  'tool.titleDataProfile': 'Perfil de dados',
  'tool.titleSql': 'Executar consulta',
  'tool.titleDatasource': 'Datasource',
  'tool.statusDelegating': 'Delegando…',
  'tool.statusPlanning': 'Planejando…',
  'tool.statusReadingPlan': 'Lendo plano…',
  'tool.statusReading': 'Lendo…',
  'tool.statusSearchingCode': 'Pesquisando codebase…',
  'tool.statusSearching': 'Pesquisando…',
  'tool.statusFindingFiles': 'Procurando arquivos…',
  'tool.statusFetching': 'Buscando…',
  'tool.statusEditing': 'Editando…',
  'tool.statusWriting': 'Escrevendo…',
  'tool.statusApplying': 'Aplicando mudanças…',
  'tool.statusRunningCmd': 'Executando comando…',
  'tool.statusThinking': 'Pensando…',
  'tool.statusLoadingSkill': 'Carregando habilidade…',
  'tool.statusWaitingInput': 'Aguardando entrada…',
  'tool.statusCompleted': 'Concluído',
  'tool.statusProcessing': 'Processando…',
  ...
  'pet.tabBuiltInHint': 'Companheiros incluídos no Aurora Design — escolha um e adote.',
  ...
  'pet.codexBundledTitle': 'Já vem com o Aurora Design — sem download.',
