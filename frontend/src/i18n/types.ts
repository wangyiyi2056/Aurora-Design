...
export interface Dict {
  'graphPanel.nodeTypes.chunk': string;
  'graphPanel.nodeTypes.concept': string;
  'graphPanel.nodeTypes.document': string;
  'graphPanel.nodeTypes.event': string;
  'graphPanel.nodeTypes.location': string;
  'graphPanel.nodeTypes.organization': string;
  'graphPanel.nodeTypes.person': string;
  'graphPanel.nodeTypes.unknown': string;

  'graphPanel.sideBar.fullScreenControl.toggle': string;
  'graphPanel.sideBar.layoutsControl.layouts.Circlepack': string;
  'graphPanel.sideBar.layoutsControl.layouts.Circular': string;
  'graphPanel.sideBar.layoutsControl.layouts.Force Atlas': string;
  'graphPanel.sideBar.layoutsControl.layouts.Force Directed': string;
  'graphPanel.sideBar.layoutsControl.layouts.Noverlaps': string;
  'graphPanel.sideBar.layoutsControl.layouts.Random': string;
  'graphPanel.sideBar.layoutsControl.select': string;
  'graphPanel.sideBar.layoutsControl.toggleAnimation': string;
  'graphPanel.sideBar.zoomControl.resetZoom': string;
  'graphPanel.sideBar.zoomControl.rotateCcw': string;
  'graphPanel.sideBar.zoomControl.rotateCw': string;
  'graphPanel.sideBar.zoomControl.zoomIn': string;
  'graphPanel.sideBar.zoomControl.zoomOut': string;

  'knowledge.v2.doc.clickOrDragHint': string;
  'knowledge.v2.doc.continueAdd': string;
  'knowledge.v2.doc.dragFilesHere': string;
  'knowledge.v2.doc.releaseToUpload': string;
  'knowledge.v2.doc.remove': string;
  'knowledge.v2.doc.retry': string;
  'knowledge.v2.doc.submittedProcessing': string;
  'knowledge.v2.doc.uploadDesc': string;
  'knowledge.v2.doc.uploadFailedRetry': string;
  'knowledge.v2.doc.uploadSuccessClose': string;
  'knowledge.v2.doc.uploadSuccessText': string;

  'common.saving': string;
  'graphPanel.propertiesView.node.propertyNames.Neighbour': string;
  'graphPanel.propertiesView.node.propertyNames.description': string;
  'graphPanel.propertiesView.node.propertyNames.entity_id': string;
  'graphPanel.propertiesView.node.propertyNames.entity_type': string;
  'graphPanel.propertiesView.node.propertyNames.keywords': string;
  'graphPanel.propertiesView.node.propertyNames.source_id': string;
  'knowledge.v2.doc.all': string;
  'knowledge.v2.doc.docDetails': string;
  'knowledge.v2.doc.docDetailsDesc': string;
  'knowledge.v2.doc.dropFiles': string;
  'knowledge.v2.doc.errorStage': string;
  'knowledge.v2.doc.insertText': string;
  'knowledge.v2.doc.insertTextDesc': string;
  'knowledge.v2.doc.insertTextPlaceholder': string;
  'knowledge.v2.doc.insertTextTitle': string;
  'knowledge.v2.doc.noDocs': string;
  'knowledge.v2.doc.noErrorMsg': string;
  'knowledge.v2.doc.page': string;
  'knowledge.v2.doc.perPage': string;
  'knowledge.v2.doc.processingError': string;
  'knowledge.v2.doc.reprocess': string;
  'knowledge.v2.doc.upload': string;
  'knowledge.v2.settings.cacheManagement': string;
  'knowledge.v2.settings.chunkSize': string;
  'knowledge.v2.settings.chunks': string;
  'knowledge.v2.settings.clearLlmCache': string;
  'knowledge.v2.settings.clearLlmCacheConfirm': string;
  'knowledge.v2.settings.clearLlmCacheTitle': string;
  'knowledge.v2.settings.collection': string;
  'knowledge.v2.settings.deleteAll': string;
  'knowledge.v2.settings.deleteAllDesc': string;
  'knowledge.v2.settings.deleteKbDesc': string;
  'knowledge.v2.settings.documents': string;
  'knowledge.v2.settings.kbInfo': string;
  'knowledge.v2.settings.llmCache': string;
  'knowledge.v2.settings.llmCacheDesc': string;
  'knowledge.v2.settings.name': string;
  'knowledge.v2.settings.queryCache': string;
  'knowledge.v2.settings.queryCacheDesc': string;
  'knowledge.v2.settings.saveConfig': string;
  'knowledge.v2.settings.strategy': string;
  ...
  'graphPanel.switchingTheme': string;
  'graphPanel.loadingGraphData': string;
  'graphPanel.dataIsTruncated': string;
  'graphPanel.emptyGraph': string;

  'graphPanel.sideBar.settings.resetToDefault': string;
  'graphPanel.sideBar.settings.settings': string;
  'graphPanel.sideBar.settings.healthCheck': string;
  'graphPanel.sideBar.settings.showPropertyPanel': string;
  'graphPanel.sideBar.settings.showSearchBar': string;
  'graphPanel.sideBar.settings.showNodeLabel': string;
  'graphPanel.sideBar.settings.nodeDraggable': string;
  'graphPanel.sideBar.settings.showEdgeLabel': string;
  'graphPanel.sideBar.settings.hideUnselectedEdges': string;
  'graphPanel.sideBar.settings.edgeEvents': string;
  'graphPanel.sideBar.settings.edgeSizeRange': string;
  'graphPanel.sideBar.settings.maxQueryDepth': string;
  'graphPanel.sideBar.settings.maxNodes': string;
  'graphPanel.sideBar.settings.maxLayoutIterations': string;
  'graphPanel.sideBar.settings.save': string;
  'graphPanel.legend': string;
  'graphPanel.search.message': string;
  'graphPanel.search.placeholder': string;
  'graphPanel.propertiesView.errors.duplicateName': string;
  'graphPanel.propertiesView.success.entityMerged': string;
  'graphPanel.propertiesView.success.entityUpdated': string;
  'graphPanel.propertiesView.errors.updateFailed': string;
  'graphPanel.propertiesView.success.relationUpdated': string;
  'graphPanel.propertiesView.mergeDialog.refreshing': string;
  'graphPanel.propertiesView.mergeDialog.title': string;
  'graphPanel.propertiesView.mergeDialog.refreshHint': string;
  'graphPanel.propertiesView.mergeDialog.keepCurrentStart': string;
  'graphPanel.propertiesView.mergeDialog.useMergedStart': string;
  'graphPanel.sideBar.settings.depth': string;
  'graphPanel.sideBar.settings.max': string;
  'graphPanel.propertiesView.editPropertyDescription': string;
  'graphPanel.propertiesView.mergeOptionLabel': string;
  'graphPanel.propertiesView.mergeOptionDescription': string;
  'graphPanel.graphLabels.refreshingTooltip': string;
  'graphPanel.graphLabels.refreshGlobalTooltip': string;
  'graphPanel.graphLabels.refreshCurrentLabelTooltip': string;
  'graphPanel.graphLabels.selectTooltip': string;
  'graphPanel.graphLabels.noLabels': string;
  'graphPanel.graphLabels.label': string;
  'graphPanel.graphLabels.placeholder': string;
  'graphPanel.propertiesView.node.title': string;
  'graphPanel.propertiesView.node.id': string;
  'graphPanel.propertiesView.node.labels': string;
  'graphPanel.propertiesView.node.degree': string;
  'graphPanel.propertiesView.node.properties': string;
  'graphPanel.propertiesView.node.relationships': string;
  'graphPanel.propertiesView.edge.title': string;
  'graphPanel.propertiesView.edge.id': string;
  'graphPanel.propertiesView.edge.type': string;
  'graphPanel.propertiesView.edge.source': string;
  'graphPanel.propertiesView.edge.target': string;
  'graphPanel.propertiesView.edge.properties': string;
  'graphPanel.propertiesView.node.noNewNodes': string;
  'graphPanel.propertiesView.node.deleteAllNodesError': string;
  'graphPanel.propertiesView.node.nodesRemoved': string;
  'graphPanel.propertiesView.editProperty': string;
  'graphPanel.refreshGraph': string;
  'graphPanel.propertiesView.mergeDialog.description': string;

  'knowledge.v2.list.chunks': string;
  'knowledge.v2.list.strategy': string;
  'knowledge.v2.list.size': string;
  'knowledge.v2.list.overlap': string;
  'knowledge.v2.list.deleteKb': string;
  'knowledge.v2.list.deleteKbDesc': string;
  'knowledge.v2.list.cancel': string;
  'knowledge.v2.list.delete': string;
  'knowledge.v2.list.createKb': string;
  'knowledge.v2.list.noKbs': string;
  'knowledge.v2.list.noKbsDesc': string;
  'knowledge.v2.list.createKbDesc': string;
  'knowledge.v2.list.name': string;
  'knowledge.v2.list.namePlaceholder': string;
  'knowledge.v2.list.nameHint': string;
  'knowledge.v2.list.chunkStrategy': string;
  'knowledge.v2.list.chunkSize': string;
  'knowledge.v2.list.chunkOverlap': string;
  'knowledge.v2.list.createFailed': string;
  'knowledge.v2.list.create': string;
  'knowledge.v2.detail.back': string;
  'knowledge.v2.detail.documents': string;
  'knowledge.v2.detail.graph': string;
  'knowledge.v2.detail.settings': string;
  'knowledge.v2.doc.uploadDoc': string;
  'knowledge.v2.doc.uploading': string;
  'knowledge.v2.doc.empty': string;
  'knowledge.v2.doc.emptyDesc': string;
  'knowledge.v2.doc.name': string;
  'knowledge.v2.doc.status': string;
  'knowledge.v2.doc.size': string;
  'knowledge.v2.doc.chunks': string;
  'knowledge.v2.doc.time': string;
  'knowledge.v2.doc.actions': string;
  'knowledge.v2.doc.extracting': string;
  'knowledge.v2.doc.cancel': string;
  'knowledge.v2.doc.delete': string;
  'knowledge.v2.doc.deleteConfirm': string;
  'knowledge.v2.doc.deleteDesc': string;
  'knowledge.v2.settings.chunkConfig': string;
  'knowledge.v2.settings.chunkConfigDesc': string;
  'knowledge.v2.settings.save': string;
  'knowledge.v2.settings.graphStatus': string;
  'knowledge.v2.settings.entities': string;
  'knowledge.v2.settings.relations': string;
  'knowledge.v2.settings.storage': string;
  'knowledge.v2.settings.dataOps': string;
  'knowledge.v2.settings.dataOpsDesc': string;
  'knowledge.v2.settings.clearCache': string;
  'knowledge.v2.settings.clearCacheDesc': string;
  'knowledge.v2.settings.clearQueryCache': string;
  'knowledge.v2.settings.clearQueryCacheDesc': string;
  'knowledge.v2.settings.deleteAllDocs': string;
  'knowledge.v2.settings.deleteAllDocsDesc': string;
  'knowledge.v2.settings.dangerZone': string;
  'knowledge.v2.settings.deleteKb': string;
  'knowledge.v2.settings.deleteKbHint': string;
  'knowledge.strategies.recursive': string;

  'knowledge.query.advancedSettings': string;
  'knowledge.query.getStructuredData': string;
  'knowledge.query.rerank': string;
  'knowledge.query.references': string;
  'knowledge.doc.reprocess': string;
  'knowledge.doc.clearLlmCache': string;
  'knowledge.doc.file': string;
  'knowledge.doc.id': string;
  'knowledge.doc.trackId': string;
  'knowledge.doc.contentLength': string;
  'knowledge.doc.summary': string;
  'knowledge.doc.created': string;
  'knowledge.doc.updated': string;
  'knowledge.doc.duration': string;
  'knowledge.settings.available': string;
  'knowledge.settings.strategy': string;
  'knowledge.settings.overlap': string;
  'knowledge.settings.saved': string;
  'knowledge.settings.clearCacheTitle': string;
  'knowledge.settings.clearQueryCacheTitle': string;
  'knowledge.settings.deleteAllDocsTitle': string;
  'knowledge.settings.deleteKbTitle': string;
  'knowledge.settings.clear': string;
}
